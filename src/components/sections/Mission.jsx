         ...
         <div className="mission-block">
            <div className="mission-block-box">
               ...
               <div className="mission-block-box-text">
                  <p>
                     Збір на 57 бригаду, котрі беруть участь в самих запеклих боях. Тому потреба в
                     розхідних матеріалах просто вееелеетенська - це і рації, і ремонт машин, гума
                     на колеса тощо. Саме тому у нас немає запиту на конкретну суму - на фронті щось
                     потрібно постійно, фінансове питання відкрите завжди.
                  </p>
               </div>
            </div>
            <div className="mission-block-box">
